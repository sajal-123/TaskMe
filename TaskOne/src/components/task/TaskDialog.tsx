...
interface Task {
  _id: string;
  [key: string]: any; // You can adjust the types here based on the properties of the task
}
...
const TaskDialog: React.FC<TaskDialogProps> = ({ task }) => {
  ...
  const duplicateHandler = () => {
    // Implement your duplicate handler logic here
  };

  const deleteClicks = () => {
    // Implement your delete click handler logic here
  };
