...
interface SelectListProps {
  lists: string[]; // Array of options to display
  selected: string; // Currently selected option
  setSelected: (value: string) => void; // Function to update the selected option
  label?: string; // Optional label for the listbox
}
