...
import { PROTOTYPES, TASK_TYPES } from "../utils";
...
const Trashed: React.FC = () => {
  ...
  const [type, setType] = useState<"delete" | "deleteAll" | "restore" | "restoreAll">("delete");
    ...
    <tr className="border-b border-gray-200 text-gray-600 hover:bg-gray-400/10">
      <td className="py-2">
        <div className="flex items-center gap-2">
          <div className={clsx("w-4 h-4 rounded-full", TASK_TYPES[item.stage])} />
      ...
      <td className="py-2 capitalize">
        <div className="flex gap-1 items-center">
          <span className={clsx("text-lg", PROTOTYPES[item.priority])}>
            {ICONS[item.priority]}
          </span>
  ...
  return (
    <>
      ...
      {/* AddUser and ConfirmationDialog components */}
